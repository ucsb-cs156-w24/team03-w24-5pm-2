...
|---------------------------|--------------|----------------|
| UCSBDiningCommonsMenuItem |Jonathan      |jonathan-herring|
| UCSBOrganization          |Olivia        |livitsimple     |
| RecommendationRequest     |Meron         |MeronDT         |
| MenuItemReview            |Allen         |aqiu28517       |
| HelpRequest               |Maria         |Maria-Saucedo   |
| Articles                  |Jiaqi         |jiaqiguan2003   |
