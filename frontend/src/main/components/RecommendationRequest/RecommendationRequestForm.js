...
function RecommendationRequestForm({ initialContents, submitAction, buttonLabel = "Create" }) {
    ...
    const email_regex = /[a-zA-Z0-9]+@[a-zA-Z0-9]+\.[a-zA-Z]/i; // Accepts from 1900-2099 followed by 1-4.  Close enough.
                ...
                <Col>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control.Feedback type="invalid">
                            ...
                            {errors.requesterEmail?.type === 'pattern' && 'requester Email must be valid.' }
