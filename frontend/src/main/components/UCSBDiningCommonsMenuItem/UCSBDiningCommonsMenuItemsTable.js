...
export default function UCSBDiningCommonsMenuItemsTable({ items, currentUser }) {
    ...
    if (hasRole(currentUser, "ROLE_ADMIN")) {
        columns.push(ButtonColumn("Edit", "primary", editCallback, "UCSBDiningCommonsMenuItemsTable"));
        columns.push(ButtonColumn("Delete", "danger", deleteCallback, "UCSBDiningCommonsMenuItemsTable"));
    } 
