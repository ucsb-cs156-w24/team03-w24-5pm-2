...
describe("UserTable tests", () => {
  ...
  test("Edit button navigates to the edit page for admin user", async () => {
    ...
    await waitFor(() => { expect(screen.getByTestId(`UCSBDiningCommonsMenuItemsTable-cell-row-0-col-id`)).toHaveTextContent("1"); });

    const editButton = screen.getByTestId(`UCSBDiningCommonsMenuItemsTable-cell-row-0-col-Edit-button`);
    expect(editButton).toBeInTheDocument();
