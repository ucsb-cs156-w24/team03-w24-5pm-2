...
public class ArticlesController extends ApiController {
    ...
    public Articles postArticles(
            ...
            @Parameter(name="dateAdded", description="dateAdded (in iso format, e.g. YYYY-mm-ddTHH:MM:SS; see https://en.wikipedia.org/wiki/ISO_8601)") @RequestParam("dateAdded") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime dateAdded)
