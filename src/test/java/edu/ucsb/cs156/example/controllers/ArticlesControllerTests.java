...
public class ArticlesControllerTests extends ControllerTestCase {
        ...
        public void an_admin_user_can_post_a_new_articles() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/articles/post?title=21+ Fun Things To Do When Bored In Class&url=https://helpfulprofessor.com/things-to-do-when-bored-in-class/&explanation=suggestions for what to do in class&email=jiaqiguan@ucsb.edu&dateAdded=2022-01-03T00:00:00")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                Articles article = Articles.builder()
                                .title("FunGame")
                                .url("https://fungame.com")
                                .explanation("suggestions for games")
                                .email("jiaqiguan@ucsb.edu")
                                .dateAdded(ldt)
                                .build();
